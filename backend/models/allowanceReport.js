    ...
    <main>
      <table>
        ...
        ${Allowance.map((Allowance) => {
          return `   
          <tr>
            <td class="service">${Allowance.fullname}</td>
            <td class="desc">${Allowance.empid}</td>
            <td class="desc">${Allowance.department}</td>
            <td class="desc">${Allowance.type}</td>
            <td class="desc">${Allowance.allowancepay}</td>
          </tr> `
        })}
        </tbody>
      </table>
