module.exports = (Leave) => {
    ...
    return `
        ...
        <div id="project">
          ...
          <div><span>Name</span>Shihara Dissanayake</div>
         
          <div><span>EMAIL</span> <a href="#">shihara@payrollx.com</a></div>
      ...
      <main>
        <table>
          ...
          ${Leave.map((leaves) => {
            return `   
            <tr>
              <td class="service">${leaves.leaveid}</td>
              <td class="desc">${leaves.empid}</td>
              <td class="desc">${leaves.fullname}</td>
              <td class="desc">${leaves.reason}</td>
              <td class="desc">${leaves.type}</td>
              <td class="desc">${leaves.noOfDays}</td
            </tr> `
          })}
          </tbody>
        </table>
