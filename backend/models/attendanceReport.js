module.exports = (Attendance) => {
    ...
    return `
        ...
        <div id="project">
          ...
          <div><span>Name</span>Amadhi Wijesinghe</div>
         
          <div><span>EMAIL</span> <a href="#">amadhi@payrollx.com</a></div>
      ...
      <main>
        <table>
          ...
          ${Attendance.map((attendance) => {
            return `   
            <tr>
              <td class="service">${attendance.empid}</td>
              <td class="desc">${attendance.fullname}</td>
              <td class="desc">${attendance.department}</td>
              <td class="desc">${attendance.checkIn}</td>
              <td class="desc">${attendance.checkOut}</td>
            </tr> `
          })}
          </tbody>
        </table>
